#
# Be sure to run `pod lib lint EFAlertController.podspec' to ensure this is a
...
A custom UIAlertController, you can set color and font of title, message and button.
  ...
  s.source_files = 'EFAlertController/Classes/**/*'
  
  # s.resource_bundles = {
  #   'EFAlertController' => ['EFAlertController/Assets/*.png']
  # }
